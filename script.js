...
Structure your output in Markdown format for clear readability. Use headings, sub-headings, and bullet points where necessary, to make it easy to read.  **Language:** English.
            `;
    } else { // Lesson Plan
        return `
